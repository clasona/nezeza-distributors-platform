    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-vesoko_green_100 rounded-lg">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setCustomColor(e.target.value)}
                      placeholder="#000000"
                      className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-vesoko_primary focus:border-transparent"
                    />
                  </div>
                  <button
                    type="button"
