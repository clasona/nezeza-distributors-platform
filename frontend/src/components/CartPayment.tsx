      ...
      {userInfo ? (
        <div className='flex flex-col items-center'>
          <button
            ...
            className='w-full h-10 text-sm font-semibold bg-nezeza_yellow  text-black rounded-lg hover:bg-nezeza_dark_blue hover:text-white duration-300'
          >
            Proceed to Checkout
          </button>
        </div>
        ...
        <div className='flex flex-col items-center'>
          <button
            // add this to make it unclickable when not logged in: cursor-not-allowed
            className='w-full h-10 text-sm font-semibold bg-nezeza_dark_blue bg-opacity-50 text-white rounded-lg cursor-not-allowed'
          >
            Proceed to Checkout
          </button>
