...
const OrderTotals = ({ order }: OrderTotalsProps) => {
  return (
    <div>
      ...
      {/* <div className='mb-2'>
        <p className='text-sm font-semibold mb-1 text-nezeza_gray_700'>
          Order Items
        </p>
        <ul>
          {order.orderItems.map((item: OrderItemsProps) => (
            <li
              ...
              className='flex justify-between text-sm text-nezeza_gray_600 mb-1'
            >
              <span>
                {item.product.title}
                <span className='ml-2 text-xs text-nezeza_dark_blue'>
                  x{item.quantity}
                </span>
              </span>
      ...
      <p className='text-sm text-nezeza_gray_600'>
        ...
        <span className='font-medium text-nezeza_dark_blue'>
