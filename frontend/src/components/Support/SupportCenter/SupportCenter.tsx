            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="space-y-1">
                  <Link href="/customer/support/faqs" className="block text-blue-600 hover:text-blue-800">Frequently Asked Questions</Link>
                  <Link href="/customer/support/submit-ticket" className="block text-blue-600 hover:text-blue-800">Submit Support Ticket</Link>
                  <Link href="/customer/support/track-package" className="block text-blue-600 hover:text-blue-800">Track Your Package</Link>
                </div>
              </div>
              <div>
