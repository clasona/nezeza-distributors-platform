...
const VerificationDocsInput = ({
  ...
  return (
    <div className='w-full'>
      ...
      <div className='bg-gray-100 p-4 rounded-md mb-4 mt-4 text-center'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-y-4 sm:gap-x-6 px-4 sm:px-6'>
        <div>
          <div className='mb-4'>
        ...
        <div>
          <div className='mb-4'>
            ...
            <p className='mb-2'>
              Required information (must match what you provided in the store
              info section):
            </p>
            <ul className='list-disc list-inside'>
