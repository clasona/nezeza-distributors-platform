...
// import { addUser } from "@/store/nextSlice";clear
...
const Header = () => {
    ...
    return (
        ...
        <div className="h-full w-full mx-auto inline-flex items-center justify-between gap-1 mdl:gap-3 px-4 ">
          ...
          <div className="text-xs">
            ...
            <div className="flex-1 h-10 hidden md:inline-flex items-center justify-between relative ">
                ...
                focus-visible:border-amazon_yellow" type="text" placeholder="Search nezeza products"/>
        ...
        {/* <div>
            <p>Hello, sign in</p>
                <p className="text-white font-bold flex">Signin/Signup{" "}
                        <span><BiCaretDown /></span>
                    </p>
                </div> */}
                <Link href={"/login"} className="flex items-center border
