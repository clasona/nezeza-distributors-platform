    ...
    <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
      <div className='bg-nezeza_light_blue p-6 rounded-lg shadow-lg w-96'>
        ...
        <div className='flex justify-end space-x-2 sm:space-x-4'>
          <button
            onClick={onClose}
            className='px-2 sm:px-4 py-2 text-nezeza_gray_600 bg-gray-300 rounded-md hover:text-white hover:bg-gray-400'
          >
            Cancel
          </button>
          <button
            onClick={handleApprove}
            className='px-2 sm:px-4 py-2 text-white bg-nezeza_green_600 rounded-md hover:bg-nezeza_green_800'
          >
            Approve
          </button>
        </div>
