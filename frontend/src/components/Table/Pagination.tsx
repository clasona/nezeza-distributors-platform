...
const Pagination = ({ data, pageSize, onPageChange }: PaginationProps) => {
  ...
  return (
    ...
    >
      <span className='text-sm font-normal text-vesoko_gray_600 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto'>
        Showing {''}
      ...
      <ul className='inline-flex -space-x-px rtl:space-x-reverse test-sm '>
        <li>
          <button
            ...
            className='flex items-center justify-center px-3 h-8 leading-tight text-vesoko_gray_600 bg-white 
