...
const FormattedStatus = ({ status }: StatusProps) => {
  const statusColors: { [key: string]: string } = {
    ...
    Placed: 'bg-vesoko_green_100 text-green-800',
    Processing: 'bg-vesoko_background text-vesoko_secondary',
    'Partially Fulfilled': 'bg-orange-100 text-orange-800',
    Fulfilled: 'bg-purple-100 text-purple-800',
    'Partially Shipped': 'bg-indigo-100 text-indigo-800',
    Shipped: 'bg-vesoko_background text-vesoko_secondary',
    ...
    Approved: 'bg-vesoko_green_100 text-vesoko_green_800',
