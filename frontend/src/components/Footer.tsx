...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-vesoko_primary via-vesoko_background to-vesoko_primary text-[#3d1f00] mt-auto">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-white/20 bg-vesoko_primary/80 mt-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1 text-[#3d1f00] text-xs">
            ...
            <Link
              ...
              className="text-vizpac_primary hover:text-vizpac_primary_dark hover:underline font-medium ml-1 flex items-center gap-1"
            >
              Clasona
