...
const SuccessPage = () => {
  ...
  return (
    <div className='flex flex-col flex-grow gap-2 items-center justify-center py-20 w-full'>
      <h1 className='text-3xl font-bold text-hoverBg text-vesoko_green_600'>
        🎉 Order Payment Processed Successfully!
      </h1>

      <p className='text-xl text-vesoko_gray_600'>
        Thank you for shopping with{' '}
        <span className='text-vesoko_dark_blue font-semibold'>VeSoko</span>!
      </p>
      <Link
        href='/'
        className='mt-4 px-6 py-3 bg-vesoko_dark_blue text-white text-lg font-medium rounded-md shadow-md hover:bg-vesoko_green_600 hover:shadow-lg transition duration-300'
      >
        Continue Shopping
      </Link>
    </div>
