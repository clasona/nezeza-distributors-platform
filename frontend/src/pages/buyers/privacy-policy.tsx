...
import { Shield, Mail, FileText, AlertCircle, Store, ShoppingBag, Truck } from 'lucide-react';
...
const PrivacyPolicy = () => {
  return (
    <>
      <Head>
        <title>Buyers Privacy Policy | VeSoko</title>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-r from-vesoko_primary via-vesoko_secondary to-vesoko_primary text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Buyers Privacy Policy</h1>
