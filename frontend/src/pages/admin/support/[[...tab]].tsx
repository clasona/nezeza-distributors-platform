...
const mockTeamStats = {
  ...
  overdueTickets: 2,
  categories: [
    { name: 'Order Issues', count: 45, icon: '📦' },
    { name: 'Payment Problems', count: 28, icon: '💳' },
    { name: 'Shipping Delays', count: 34, icon: '🚚' },
    { name: 'Product Quality', count: 19, icon: '⭐' },
    { name: 'Returns & Refunds', count: 21, icon: '↩️' }
  ],
  agents: [
