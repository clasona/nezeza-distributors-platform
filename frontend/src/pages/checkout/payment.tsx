...
const CheckoutPaymentPage = () => {
  ...
  return (
    <div className='bg-nezeza_powder_blue min-h-screen p-4 md:p-8 flex items-center justify-center'>
      <div className='w-full max-w-lg p-6 bg-white shadow-lg rounded-lg'>
        <h2 className='text-2xl font-bold mb-4 text-center text-nezeza_dark_blue'>
