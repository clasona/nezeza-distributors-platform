...
const PostStoreApplicationSubmission = () => {
  return (
    <div className='min-h-screen bg-gradient-to-br from-green-50 via-vesoko_background_light to-purple-50'>
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        {/* Success Header */}
        <div className='text-center mb-12'>
          <div className='inline-flex items-center justify-center w-20 h-20 bg-vesoko_green_100 rounded-full mb-6'>
            <CheckCircle className='h-12 w-12 text-green-500' />
          </div>
          
          <h1 className='text-4xl md:text-5xl font-bold text-gray-900 mb-4'>
            Application Submitted
            <span className='block text-vesoko_primary'>Successfully!</span>
          </h1>
          <p className='text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed'>
            ...
            <span className='font-semibold text-vesoko_primary'>Our team will review your application and notify you within <span className='text-vesoko_primary'>48 hours</span>.</span>
          </p>
        </div>
        ...
        <div className='bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-8'>
          ...
          <div className='bg-gradient-to-r from-vesoko_primary to-vesoko_primary px-8 py-6'>
            ...
            <p className='text-white'>Here's what you can expect during our review process</p>
          </div>
          ...
          <div className='p-8'>
            <div className='grid md:grid-cols-3 gap-8 mb-8'>
              ...
              {/* Step 3 */}
              <div className='text-center'>
                <div className='inline-flex items-center justify-center w-16 h-16 bg-vesoko_green_100 rounded-full mb-4'>
            ...
            <div className='bg-gradient-to-r from-vesoko_primary50 to-purple-50 rounded-xl p-6 mb-8'>
              ...
              <ul className='space-y-2 text-gray-600'>
                ...
                <li className='flex items-center gap-2'>
                  <CheckCircle className='h-4 w-4 text-green-500 flex-shrink-0' />
                  <span>
                    <span className='font-semibold text-vesoko_primary'>Review Timeline:</span> Most applications are reviewed within <span className='text-vesoko_primary'>48 hours</span>.
                  </span>
                </li>
                <li className='flex items-center gap-2'>
                  <CheckCircle className='h-4 w-4 text-green-500 flex-shrink-0' />
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
          <Link 
            href='/'
            className='inline-flex items-center gap-2 bg-vesoko_primary text-white px-8 py-3 rounded-lg font-medium hover:bg-vesoko_primary transition-all duration-200 transform hover:scale-105 shadow-lg'
          >
          ...
          <Link 
            href='/sellers'
            className='inline-flex items-center gap-2 bg-white text-vesoko_primary border-2 border-vesoko_primary px-8 py-3 rounded-lg font-medium hover:bg-vesoko_primary hover:text-white transition-all duration-200 shadow-lg'
          >
