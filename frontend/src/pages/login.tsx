    ...
    return (
      ...
      <div className='w-full flex items-center justify-center gap-4'>
        <form className='py-10' onSubmit={handleSubmit}>
          ...
          <button
            type='submit'
            className='w-full h-10 rounded-md font-medium bg-amazon_blue text-white hover:bg-amazon_yellow 
          ...
          <p>
            New to Nezeza?{' '}
            <a
              className='text-amazon_yellow hover:text-amazon_blue  hoverunderline decoration-[1px]
