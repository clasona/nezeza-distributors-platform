  ...
  return (
    <div className='w-screen h-screen flex flex-col bg-vesoko_powder_blue gap-2 items-center justify-center py-20 px-4 sm:px-6'>
      <div className='text-center mt-6'>
        <h1 className='text-2xl font-semibold text-vesoko_gray_800 mb-2'>
          Sell on VeSoko Platform
        </h1>
        ...
        <div className='mt-6 flex justify-center gap-4'>
          <button
            className='px-4 py-2 rounded-md bg-vesoko_dark_blue text-white hover:bg-vesoko_green_800 transition-colors duration-300'
        ...
        <p className='mt-4 text-vesoko_gray_800 font-semibold'>
