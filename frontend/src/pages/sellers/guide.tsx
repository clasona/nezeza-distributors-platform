          ...
          <div className='grid md:grid-cols-2 gap-8'>
            {phases.map((phase, index) => (
              <div key={index} className='bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300'>
                ...
                <h4 className='text-xl font-semibold text-vesoko_dark_blue mb-4'>{phase.title}</h4>
                ...
                <div key={index} className='relative'>
                  <div className='flex flex-col md:flex-row items-start gap-8 bg-white rounded-2xl p-8 shadow-lg border border-gray-200'>
                    ...
                    <div className='flex-shrink-0 flex flex-col items-center'>
                      <div className='w-16 h-16 bg-gradient-to-r from-vesoko_dark_blue to-vesoko_green_600 rounded-full flex items-center justify-center text-white text-xl font-bold mb-4'>
                        {step.step}
                      </div>
                    ...
                    <div className='flex-1'>
                      <div className='flex flex-col md:flex-row md:items-center md:justify-between mb-4'>
                        ...
                        <span className='text-sm font-medium text-vesoko_green_600 bg-vesoko_green_50 px-3 py-1 rounded-full mt-2 md:mt-0'>
                          {step.timeframe}
                        </span>
                      </div>
                  ...
                  {!isLast && (
                    <div className='flex justify-center mt-4 mb-4'>
                      <div className='w-0.5 h-8 bg-gradient-to-b from-vesoko_dark_blue to-vesoko_green_600'></div>
                    </div>
                  )}
                </div>
              );
      ...
      <div className='py-24 bg-gradient-to-r from-gray-50 to-blue-50'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <div className='grid md:grid-cols-2 gap-8 mb-12'>
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-200'>
              <MessageSquare className='h-12 w-12 text-vesoko_green_600 mx-auto mb-6' />
              <h3 className='text-xl font-semibold text-gray-900 mb-4'>Live Chat</h3>
              <p className='text-gray-600 mb-6'>Quick answers during business hours</p>
              <div className='text-vesoko_green_600 font-medium'>
          ...
          <div className='bg-white/60 backdrop-blur-sm rounded-xl border border-white/20 p-8'>
            ...
            <div className='grid md:grid-cols-2 gap-4'>
              ...
              <Link 
                ...
                className='flex items-center justify-center gap-2 bg-vesoko_dark_blue text-white px-6 py-3 rounded-lg font-medium hover:bg-vesoko_green_600 transition-colors'
              >
